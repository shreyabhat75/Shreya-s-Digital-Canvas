        ...
        <div>
          ...
          >
            ...
            <span className="text-foreground/90">
              Engineer, builder, <em className="not-italic text-gradient">creative</em>{" "}
              problem solver.
            </span>
          </motion.h1>
          ...
          >
            I build technology experiences that combine design, intelligence and
            real-world impact — from AI tools to crafted interfaces.
          </motion.p>
